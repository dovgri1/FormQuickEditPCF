...
export interface IHourEntryGridEditor {
	/**
...
export type ColumnDataType =
	...
	export interface ITextCellRenderer {
		props: CellRendererProps;
		col: GetRendererParams;
	  }

	  export interface IBooleanLabels {
		trueLabel: string
		falseLabel: string;
	  }
	  ...
	  export interface IField {
		...
		fieldName?: string;
		booleanLabels? : IBooleanLabels
	  }
	  
	  export type IFluentUIFieldTypes = "Text" | "Number" | "Date" | "DateTime" | "Boolean" | "LongText" | "Lookup" | "Customer" | "OptionSet";